...
module.exports = Vue.component('modal', {
  ...
  computed: {
    validateForm: function () {
      if (this.text === '' || this.taskDate === '') return false;else return true;
    }
  },
  methods: {
    addTask: function () {
...
},{"./task":6,"vue":2}],6:[function(require,module,exports){
const Vue = require('vue');
...
const app = new Vue({
    ...
    data: {
        title: 'Vue TODO App',
        todos: [{ id: 1, text: 'Today task 1', isDone: false, date: 'today' }, { id: 2, text: 'Today task 2', isDone: false, date: 'today' }, { id: 3, text: 'Tommorow Task 3', isDone: false, date: 'tommorow' }, { id: 4, text: 'Tommorow Task 4 Done', isDone: true, date: 'tommorow' }],
        mapTodos: [],
        showModal: false,
        toShow: 'all'
    },
    ...
    methods: {
        ...
        renderTasksByDate: function (date) {
            this.mapTodos = this.todos.filter(function (task) {
                if (task.date == date) return true;else return false;
            });
        },

        renderTasksByDone: function () {
            this.mapTodos = this.todos.filter(function (task) {
                if (task.isDone == true) return true;else return false;
            });
        },
...
},{"./components/modal":3,"./components/tabs":4,"./components/tasks/task-list":5,"vue":2}]},{},[7])